...
//      Maak hier 2 knoppen aan die de keuzes aangeven.
        this._createAdButton('<!-- Button naam -->', this.changeAdO);
        this._createAdButton('<!-- Button naam -->', this.changeAdF);
...
// 2.   Stijl de buttons naar wens door middel van Javascript style toe te voegen. Bij de 'adhover' functie kan style worden aangegeven bij een hover.
    ...
    adButton.style./* javascript style --> */ = “/* waardes */”;

    function adhover(button) {
        button.onmouseover = function(e){
            button.style./* javascript style --> */ = “/* waardes */”;
        }
...
// 3. Check of de defaultvideo goed staat. Wanneer de video eerste video af is gespeeld zonder interactie wordt de default video afgespeeld. Door de functie 'ChangeAdO' wordt aangeroepen, wordt video 1 (in XML file de tweede) afgespeeld. Deze kan je veranderen naar 'ChangeADF' om de tweede (in xml file derde) video default te maken.
    if (this._videoSlot['src'] == this._videos[0]['url']) {
        this./*changeAdO(); of changeAdF();*/
    }
    else{
