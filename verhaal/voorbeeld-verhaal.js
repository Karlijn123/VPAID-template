...
VpaidVideoPlayer.prototype._createAdButton = function(text, eventType) {
    ...
    adButton.style.width = "20vw";
    adButton.style.height = "10vh";
    adButton.style.backgroundColor = "rgba(255,255,255,0.4)";
    adButton.style.marginTop = "70vh";
    adButton.style.marginLeft = "20vw";

    function adhover(button) {
        button.onmouseover = function(e){
            adButton.style.backgroundColor = "rgba(255,255,255,1)";
        }
